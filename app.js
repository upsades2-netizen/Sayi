...
window.scrollTo({ top: 0, behavior: "smooth" }) } function openDetail(id) { let s = data.subjects.find(x => x.id === id);
if (!s) return;
...
return } if (b.dataset.selectColor) { let form = b.closest("form"), input = form?.querySelector("[name=color]");
